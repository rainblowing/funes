...
worth nothing — though note that the fixture and its evaluator live in the harness repo, not this
one, so "interrogate" is currently a promise rather than something this repository lets you do.
